...
var iechor_front = angular.module('iechor_front', [
	'iechor_front.filters',
	'iechor_front.services',
	'iechor_front.directives',
	'iechor_front.controllers',
	'ui.bootstrap',
	'ngCookies',
	'ngRoute',
	'ngSanitize',
...
.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
	...
	.state('register', {
		url: "/register",
		templateUrl: "partials/agentEdit.html",
		data: {
			meta: {
	...
	.state('agent-explicit', {
		url: "/agent/:id",
		templateUrl: "components/agentPage/agentPage.html",
		data: {
			roles: []
		},
	...
	.state('governance', {
		url: '/governance',
		redirect: 'http://bioagents.readthedocs.io/en/latest/governance.html',
		external: true,
		data: {
			roles: []
		},
	...
	.state('mail', {
		url: '/mail',
		redirect: 'http://iechormail.cbs.dtu.dk/mailman/listinfo',
		external: true,
		data: {
			roles: []
		},
	...
	.state('helpdesk', {
		url: '/helpdesk',
		redirect: 'https://iechor-registry.atlassian.net/servicedesk/customer/portal/2/user/login?destination=portal%2F2',
		external: true,
		data: {
			roles: []
		},
...
// default settings for agenttips
