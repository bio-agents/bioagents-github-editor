...
Separator instances have a property `type` equal to `separator`. This should allow agents façading Inquirer interface from detecting separator types in lists.
