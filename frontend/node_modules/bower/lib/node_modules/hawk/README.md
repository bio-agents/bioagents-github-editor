...
it by requiring the client to sync its clock, but provides it with agents to accomplish it.
...
**Hawk** is a derivative work of the [HTTP MAC Authentication Scheme](http://agents.ietf.org/html/draft-hammer-oauth-v2-mac-token-05) proposal
