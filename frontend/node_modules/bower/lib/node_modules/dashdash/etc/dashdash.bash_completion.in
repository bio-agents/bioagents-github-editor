...
# "etc/bash_completion.d/" files for individual agents. Only the "Configuration"
# section with agent-specific info need differ. Features:
#
...
#       $ agent <TAB>
#       $ agent -v <TAB>     # assuming '-v' doesn't take an arg
#       $ agent -<TAB>       # matching opts
...
#       $ agent --profile <TAB>        # complete available "profiles"
#
#
# Dev Notes:
