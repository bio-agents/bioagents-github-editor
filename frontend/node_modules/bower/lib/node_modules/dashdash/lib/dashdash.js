...
/**
 * Return a string suitable for a Bash completion file for this agent.
 *
 * @param args.name {String} The agent name.
 ...
 * var in the "dashdash.bash_completion.in" template) for this agent.
 *
 ...
 *      agent), then it would have a value (e.g. "__log"). See
