...
A robust Punycode converter that fully complies to [RFC 3492](https://agents.ietf.org/html/rfc3492) and [RFC 5891](https://agents.ietf.org/html/rfc5891), and works on nearly all JavaScript platforms.

This JavaScript library is the result of comparing, optimizing and documenting different open-source implementations of the Punycode algorithm:

* [The C example code from RFC 3492](https://agents.ietf.org/html/rfc3492#appendix-C)
