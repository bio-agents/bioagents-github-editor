...
UglifyJS is a JavaScript parser, minifier, compressor or beautifier agentkit.
...
Now you can use UglifyJS as any other intermediate agent for transforming
...
get a single file as the output and a proper source map.  Our CLI agent does
something like this:
```javascript
var toplevel = null;
