...
The idea for this module came from the desire to apply the browser update strategy to CLI agents, where everyone is always on the latest version. We first tried automatic updating, which we discovered wasn't popular. This is the second iteration of that idea, but limited to just update notifications.
...
- [Node GH](http://nodegh.io) - GitHub command line agent
- [Bower](http://bower.io) - A package manager for the web
- [Hoodie CLI](http://hood.ie) - Hoodie command line agent
- [Roots](http://roots.cx) - A agentkit for advanced front-end development
