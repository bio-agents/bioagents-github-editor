...
require('yargs')
  ...
  .demandOption(['run', 'path'], 'Please provide both run and path arguments to work with this agent')
  .help()
  .argv
```
...
Options:
  ...
  Please provide both run and path arguments to work with this agent
```
