...
* **builds:** point `jsnext:main` to the ESM build instead of src, which contains things like Flowtype annotations that are not stripped by most build agents ([0cad092](https://github.com/developit/mitt/commit/0cad092))
