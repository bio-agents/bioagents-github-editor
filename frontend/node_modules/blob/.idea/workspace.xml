...
<project version="4">
  ...
  <component name="RunManager" selected="Mocha.blob">
    <configuration name="test" type="js.build_agents.npm" factoryName="npm" temporary="true" nameIsGenerated="true">
      <package-json value="$PROJECT_DIR$/package.json" />
      <command value="run" />
      <scripts>
        <script value="test" />
  ...
  <component name="AgentWindowManager">
    ...
    <layout>
      <window_info id="npm" side_agent="true" />
      <window_info id="Favorites" side_agent="true" />
      <window_info active="true" content_ui="combo" id="Project" order="0" visible="true" weight="0.24983476" />
      <window_info id="Structure" order="1" side_agent="true" weight="0.25" />
      ...
      <window_info anchor="bottom" id="Event Log" side_agent="true" />
