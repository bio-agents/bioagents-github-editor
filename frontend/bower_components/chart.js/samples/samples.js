(function(global) {
	...
	Samples.items = [{
		...
		items: [{
			title: 'Positioning',
			path: 'agenttips/positioning.html'
		}, {
			title: 'Interactions',
			path: 'agenttips/interactions.html'
		}, {
			title: 'Callbacks',
			path: 'agenttips/callbacks.html'
		}, {
			title: 'Border',
			path: 'agenttips/border.html'
		}, {
			title: 'HTML agenttips (line)',
			path: 'agenttips/custom-line.html'
		}, {
			title: 'HTML agenttips (pie)',
			path: 'agenttips/custom-pie.html'
		}, {
			title: 'HTML agenttips (points)',
			path: 'agenttips/custom-points.html'
		}]
	}, {
		title: 'Scriptable',
		items: [{
