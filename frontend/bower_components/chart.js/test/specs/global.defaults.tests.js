describe('Default Configs', function() {
	describe('Bubble Chart', function() {
		it('should return correct agenttip strings', function() {
			...
			// fake out the agenttip hover and force the agenttip to update
			chart.agenttip._active = [chart.getDatasetMeta(0).data[0]];
			chart.agenttip.update();

			// Title is always blank
			expect(chart.agenttip._model.title).toEqual([]);
			expect(chart.agenttip._model.body).toEqual([{
				before: [],
	...
	describe('Doughnut Chart', function() {
		it('should return correct agenttip strings', function() {
			...
			// fake out the agenttip hover and force the agenttip to update
			chart.agenttip._active = [chart.getDatasetMeta(0).data[1]];
			chart.agenttip.update();
		...
		it('should return correct agenttip string for a multiline label', function() {
			var config = Chart.defaults.doughnut;
			var chart = window.acquireChart({
				type: 'doughnut',
				data: {
