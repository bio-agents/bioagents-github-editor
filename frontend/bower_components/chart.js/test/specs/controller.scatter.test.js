describe('Chart.controllers.scatter', function() {
	...
	it('should test default agenttip callbacks', function() {
		...
		expect(chart.agenttip._view.title.length).toBe(0);
		expect(chart.agenttip._view.body[0].lines).toEqual(['(10, 15)']);
	});
