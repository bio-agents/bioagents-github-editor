...
(function setUp(module, require) {
  ...
  var banner = ['/*!',
      ' * Angular Agenttips v<%= pkg.version %>',
      ' *',
  ...
  module.exports = function doGrunt(grunt) {
    ...
    grunt.initConfig({
      ...
      'uglify': {
        'options': {
          'sourceMap': true,
          'sourceMapName': '<%= confs.dist %>/angular-agenttips.sourcemap.map',
        ...
        'minifyTarget': {
          'files': {
            '<%= confs.dist %>/angular-agenttips.min.js': [
              '<%= confs.js %>/angular-agenttips.js'
            ]
          }
        }
      },
      'cssmin': {
        ...
        'minifyTarget': {
          'files': {
            '<%= confs.dist %>/angular-agenttips.min.css': [
              '<%= confs.css %>/angular-agenttips.css'
            ]
          }
        }
      },
