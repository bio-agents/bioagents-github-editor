...
.controller('HomeController', ['$scope','$state', '$stateParams', function($scope, $state, $stateParams) {
	...
	angular.module('iechor_front')
.directive('homeSearch', ['Query', 'AgentList', 'Highlighting', 'Attribute', '$state', '$stateParams', '$timeout', 'UsedTerms', '$q', 'filterFilter', 'Domain', '$rootScope', function(Query, AgentList, Highlighting, Attribute, $state, $stateParams, $timeout, UsedTerms, $q, filterFilter, Domain, $rootScope) {
	return {
		restrict: 'A',
		...
		link: function(scope, element, attrs) {
			...
			/*$rootScope.$on('$stateChangeSuccess', function(event, toState, toStateParams, fromState, fromStateParams) {
				if (toState.name === 'agent' || toState.name === 'home') { 
					Query.current = [];
				}
